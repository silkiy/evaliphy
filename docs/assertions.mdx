...
- **Judge Prompt**: [`toBeFaithful.md`](https://github.com/evaliphy/evaliphy/blob/main/packages/prompts/toBeFaithful.md)
...
- **Judge Prompt**: [`toBeRelevant.md`](https://github.com/evaliphy/evaliphy/blob/main/packages/prompts/toBeRelevant.md)
...
- **Judge Prompt**: [`toBeGrounded.md`](https://github.com/evaliphy/evaliphy/blob/main/packages/prompts/toBeGrounded.md)
...
- **Judge Prompt**: [`toBeCoherent.md`](https://github.com/evaliphy/evaliphy/blob/main/packages/prompts/toBeCoherent.md)
...
- **Required Input**: `response`
- **Judge Prompt**: [`toBeHarmless.md`](https://github.com/evaliphy/evaliphy/blob/main/packages/prompts/toBeHarmless.md)
