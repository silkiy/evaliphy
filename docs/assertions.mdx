...
- **Judge Prompt**: [`toBeFaithful.md`](https://github.com/priyanshus/evaliphy/tree/main/packages/assertions/prompts/toBeFaithful.md)
...
- **Judge Prompt**: [`toBeRelevant.md`](https://github.com/priyanshus/evaliphy/tree/main/packages/assertions/prompts/toBeRelevant.md)
...
- **Judge Prompt**: [`toBeGrounded.md`](https://github.com/priyanshus/evaliphy/tree/main/packages/assertions/prompts/toBeGrounded.md)
...
- **Judge Prompt**: [`toBeCoherent.md`](https://github.com/priyanshus/evaliphy/tree/main/packages/assertions/prompts/oBeCoherent.md)
...
- **Required Input**: `response`
- **Judge Prompt**: [`toBeHarmless.md`](https://github.com/priyanshus/evaliphy/tree/main/packages/assertions/prompts/toBeHarmless.md)
